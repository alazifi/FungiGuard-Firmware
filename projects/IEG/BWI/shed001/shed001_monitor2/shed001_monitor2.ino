...
void setup()
{
  ...
  ArduinoOTA.setHostname("bwi-001-monitoring-unit-02");
...
void printLCD()
{
  ...
  lcd.print("SK4: ");
  lcd.setCursor(4, 0);
  lcd.print(sensors.getTempC(probe4), 1);
  lcd.setCursor(8, 0);
  lcd.print("C");
  ...
  lcd.print("SK5: ");
  lcd.setCursor(4, 1);
  lcd.print(sensors.getTempC(probe5), 1);
  lcd.setCursor(8, 1);
  lcd.print("C");
  ...
  lcd.print("SK6: ");
  lcd.setCursor(4, 2);
  lcd.print(sensors.getTempC(probe6), 1);
  lcd.setCursor(8, 2);
  lcd.print("C");
...
void sendData()
{
  ...
  doc["bwi_001_u02_compose_temp4"] = sensors.getTempC(probe4);
  doc["bwi_001_u02_compose_temp5"] = sensors.getTempC(probe5);
  doc["bwi_001_u02_compose_temp6"] = sensors.getTempC(probe6);
  doc["bwi_001_u02_room_temp2"] = roomTemperature();
  doc["bwi_001_u02_humidity2"] = humidity();
  doc["bwi_001_u02_carbon_dioxide2"] = carbonDioxide();
